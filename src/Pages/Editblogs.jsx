...
import Editblogs_under from "../components/Editblogs_under";
...
const Editblogs = () => {
  ...
  const [Heading, setHeading] = useState("Edit Blogs");
  const [SubHeading, setSubHeading] = useState("Edit Blogs");
