...
const Dashboard = () => {
  ...
  const [SubHeading, setSubHeading] = useState("Home");
  ...
  return (
    <div className="main_dashboard">
      ...
      <section
        id="sidebar"
        // className={`${isHide ? "siderbarshow" : "sidebarhide"} `}
        style={{ width: isHide ? "280px" : "60px" }}
      >
        <a
          href="#"
          className="brand"
        ...
        <ul className="side-menu top">
          <li className={tab === "dashboard" ? "active" : ""}>
            <a
              href="#"
              // className={`${isHide ? "siderbarshow" : "sidebarhide1"} `}
              style={{
