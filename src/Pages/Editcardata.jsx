...
import Editcardata_under from "../components/Editcardata_under";
...
const Editcardata = () => {
  ...
  const [tab, setTab] = useState("Editcardata");
  const [Heading, setHeading] = useState("Edit Car Data");
  const [SubHeading, setSubHeading] = useState("Edit Car Data");
    ...
    <div className="main_dashboard">
      ...
      <section id="sidebar" style={{ width: isHide ? "280px" : "60px" }}>
        ...
        <ul className="side-menu top">
          ...
          <li className={tab === "Editcardata" ? "active" : ""}>
            <a
              href="#"
              style={{
                width: isHide ? "100%" : "calc(48px - (4px * 2))",
      ...
      >
        ...
        <main>
          ...
          {tab === "Editcardata" ? <Editcardata_under /> : ""}
        </main>
        {/* <!-- MAIN --> */}
      </section>
      {/* <!-- CONTENT --> */}
