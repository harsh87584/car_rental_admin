...
const Bookingdata = () => {
  ...
  const [Heading, setHeading] = useState("User Booking Information");
  const [SubHeading, setSubHeading] = useState("User Booking Information");
    ...
    <div className="main_dashboard">
      ...
      >
        ...
        <main>
          ...
          {tab === "Booking" ? <UserBookingFormdata /> : ""}
        </main>
        {/* <!-- MAIN --> */}
      </section>
      {/* <!-- CONTENT --> */}
