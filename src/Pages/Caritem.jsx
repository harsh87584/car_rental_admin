...
const Caritem = () => {
  ...
  const [tab, setTab] = useState("Caritem");
  const [Heading, setHeading] = useState("Car List");
  const [SubHeading, setSubHeading] = useState("Car List");
    ...
    <div className="main_dashboard">
      ...
      <section id="sidebar" style={{ width: isHide ? "280px" : "60px" }}>
        ...
        <ul className="side-menu top">
          ...
          <li className={tab === "Caritem" ? "active" : ""}>
            <a
              href="#"
              style={{
                width: isHide ? "100%" : "calc(48px - (4px * 2))",
